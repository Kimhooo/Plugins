...
import com.kimho.plugin_c2webp.util.ImageUtil
...
//                println("--- ${file.absolutePath}")
        ...
        if (imageFileList.size < coreNum) {
            ...
            for (f in results) {
                try {
                    ...
                    println(" C2WebpTask#dispatchOptimizeTask() execute wrong.")
                }
            }
        }
    }
    ...
    private fun checkCwebpTools() {
        ...
        if (!WebpToolBean.getToolsDir().exists()) {
            throw GradleException("C2WebpTask need cwebp tool.")
        }
    }
